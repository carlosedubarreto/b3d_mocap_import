...
class Import_Data_frankmocap(Operator, ImportHelper):
    ...
    def execute(self,context):
        ...
        #nppic['pred_output_list'][0]['pred_body_pose']
        #ppic['pred_output_list'][0]['pred_body_pose'].size
        #len(nppic['pred_output_list'][0]['pred_body_pose'][0])

        #values = nppic['pred_output_list'][0]['pred_body_pose'][0]
        ...
        #bpy.context.object.data.edit_bones["Bone"].name = 'Spine'
        #bpy.context.object.data.edit_bones["Bone.001"].name = 'Neck'
        #bpy.context.object.data.edit_bones["Bone.002"].name = 'Face'
        #bpy.context.object.data.edit_bones["Bone.003"].name = 'Arm_L'
        #bpy.context.object.data.edit_bones["Bone.004"].name = 'Forearm_L'
        #bpy.context.object.data.edit_bones["Bone.005"].name = 'Arm_R'
        #bpy.context.object.data.edit_bones["Bone.006"].name = 'Forearm_R'
        #bpy.context.object.data.edit_bones["Bone.007"].name = 'Thigh_L'
        #bpy.context.object.data.edit_bones["Bone.008"].name = 'Leg_L'
        #bpy.context.object.data.edit_bones["Bone.009"].name = 'Foot_L'
        #bpy.context.object.data.edit_bones["Bone.010"].name = 'Thigh_R'
        #bpy.context.object.data.edit_bones["Bone.011"].name = 'Leg_R'
        #bpy.context.object.data.edit_bones["Bone.012"].name = 'Foot_R'
        ...
        #=============================
        #giving movement to Points
        #=============================

        #nppic['pred_output_list'][0]['pred_joints_img'][0]
        #nppic['pred_output_list'][0]['pred_body_joints_img'][0]
        ...
        size_bone("Point.039", "Point.037", "Spine")
        size_bone("Point.037", "Point.042", "Neck")
        size_bone("Point.042", "Point.044", "Face")

        size_bone("Point.033", "Point.032", "Arm_L")
        size_bone("Point.032", "Point.031", "Forearm_L")

        size_bone("Point.034", "Point.035", "Arm_R")
        size_bone("Point.035", "Point.036", "Forearm_R")

        size_bone("Point.009", "Point.026", "Thigh_L")
        size_bone("Point.026", "Point.025", "Leg_L")
        size_bone("Point.025", "Point.022", "Foot_L")

        size_bone("Point.012", "Point.029", "Thigh_R")
        size_bone("Point.029", "Point.030", "Leg_R")
        size_bone("Point.030", "Point.019", "Foot_R")
        ...
        bpy.ops.pose.constraint_add(type='DAMPED_TRACK')
        bpy.context.object.pose.bones[actual_bone].constraints[1].target = bpy.data.objects["Point.032"]
        #=====
        actual_bone = 'Forearm_L'
        bpy.context.object.data.bones.active = bpy.data.objects[armature].pose.bones[actual_bone].bone
        bpy.context.object.pose.bones[actual_bone].bone.select = True
        ...
        bpy.ops.pose.constraint_add(type='COPY_LOCATION')
        bpy.context.object.pose.bones[actual_bone].constraints[0].target = bpy.data.objects["Point.034"]
        bpy.ops.pose.constraint_add(type='DAMPED_TRACK')
        bpy.context.object.pose.bones[actual_bone].constraints[1].target = bpy.data.objects["Point.035"]
        #=====
        actual_bone = 'Forearm_R'
        bpy.context.object.data.bones.active = bpy.data.objects[armature].pose.bones[actual_bone].bone
        bpy.context.object.pose.bones[actual_bone].bone.select = True
        ...
        bpy.context.object.pose.bones[actual_bone].constraints[0].target = bpy.data.objects["Point.012"]
        bpy.ops.pose.constraint_add(type='DAMPED_TRACK')
        bpy.context.object.pose.bones[actual_bone].constraints[1].target = bpy.data.objects["Point.029"]
        #=====
        actual_bone = 'Leg_R'
        bpy.context.object.data.bones.active = bpy.data.objects[armature].pose.bones[actual_bone].bone
        bpy.context.object.pose.bones[actual_bone].bone.select = True
...
class Import_Data_vibe(Operator, ImportHelper):
    ...
    def execute(self,context):
        ...
        #bpy.context.object.data.edit_bones["Bone.001"].name = 'Neck'
        ##bpy.context.object.data.edit_bones["Bone.002"].name = 'Face'
        #bpy.context.object.data.edit_bones["Bone.002"].name = 'Arm_L'
        #bpy.context.object.data.edit_bones["Bone.003"].name = 'Forearm_L'
        #bpy.context.object.data.edit_bones["Bone.004"].name = 'Arm_R'
        #bpy.context.object.data.edit_bones["Bone.005"].name = 'Forearm_R'
        #bpy.context.object.data.edit_bones["Bone.006"].name = 'Thigh_L'
        #bpy.context.object.data.edit_bones["Bone.007"].name = 'Leg_L'
        #bpy.context.object.data.edit_bones["Bone.008"].name = 'Foot_L'
        #bpy.context.object.data.edit_bones["Bone.009"].name = 'Thigh_R'
        #bpy.context.object.data.edit_bones["Bone.010"].name = 'Leg_R'
        #bpy.context.object.data.edit_bones["Bone.011"].name = 'Foot_R'
        ...
        obs[len(obs)-1].data.edit_bones["Bone.001"].name = 'Neck'
        #obs[len(obs)-1].data.edit_bones["Bone.002"].name = 'Face'
        obs[len(obs)-1].data.edit_bones["Bone.002"].name = 'Arm_L'
        obs[len(obs)-1].data.edit_bones["Bone.003"].name = 'Forearm_L'
        obs[len(obs)-1].data.edit_bones["Bone.004"].name = 'Arm_R'
        obs[len(obs)-1].data.edit_bones["Bone.005"].name = 'Forearm_R'
        obs[len(obs)-1].data.edit_bones["Bone.006"].name = 'Thigh_L'
        obs[len(obs)-1].data.edit_bones["Bone.007"].name = 'Leg_L'
        obs[len(obs)-1].data.edit_bones["Bone.008"].name = 'Foot_L'
        obs[len(obs)-1].data.edit_bones["Bone.009"].name = 'Thigh_R'
        obs[len(obs)-1].data.edit_bones["Bone.010"].name = 'Leg_R'
        obs[len(obs)-1].data.edit_bones["Bone.011"].name = 'Foot_R'
        ...
        size_bone("Point.008", "Point.001", "Spine")
        size_bone("Point.001", "Point.000", "Neck")
        #size_bone("Point.042", "Point.044", "Face")

        size_bone("Point.005", "Point.006", "Arm_L")
        size_bone("Point.006", "Point.007", "Forearm_L")

        size_bone("Point.002", "Point.003", "Arm_R")
        size_bone("Point.003", "Point.004", "Forearm_R")
        ...
        #
        #bpy.ops.pose.constraint_add(type='DAMPED_TRACK')
        #bpy.context.object.pose.bones[actual_bone].constraints["Damped Track"].target = bpy.data.objects["Point.044"]
        #=====
...
class Mediapipe_Pose_estimation(Operator, ImportHelper):
    ...
    def execute(self,context):
        ...
        # path = r'D:\MOCAP\VIBE\sample_video.mp4'
        path = self.filepath
